...
export default function PostListSkeleton() {
  const PostCardSkeleton = () => (
    <div className="relative group h-full skeleton-card">
      {/* Notification badge skeleton */}
      <div className="absolute -top-3 -right-3 min-w-[32px] h-8 px-2 flex items-center justify-center rounded-full shadow-md z-20 pointer-events-none bg-gray-200 dark:bg-[#8899AC]" style={{ willChange: 'opacity' }}>
      ...
      <div className="relative h-[260px] bg-white dark:bg-[#151515] border-2 border-gray-200 dark:border-gray-700 rounded-xl flex flex-col p-4 overflow-visible">
        ...
        <div className="flex justify-between items-center mb-3 text-sm text-gray-500 dark:text-gray-400">
          <div className="flex items-center gap-2">
            ...
            <div className="h-4 w-14 rounded bg-gray-200 dark:bg-[#8899AC]" />
          </div>
        </div>
  ...
  return (
    <div className="pt-6">
      ...
      <div className="mb-6">
        <h3 className="text-xl font-semibold text-black dark:text-white mb-4 flex items-center skeleton-card">
          <div className="h-6 w-6 bg-gray-200/60 dark:bg-[#8899AC] rounded mr-3"></div>
          <div className="h-6 bg-gray-200/60 dark:bg-[#8899AC] rounded w-32"></div>
        </h3>
      ...
      <div className="mb-6">
        <h3 className="text-xl font-semibold text-black dark:text-white mb-4 flex items-center skeleton-card">
          <div className="h-5 w-5 bg-gray-200/60 dark:bg-[#8899AC] rounded mr-2"></div>
          <div className="h-6 bg-gray-200/60 dark:bg-[#8899AC] rounded w-48"></div>
        </h3>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
